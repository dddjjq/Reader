...
public class BookDetail implements Serializable{
    ...
    private ArrayList<String> hiddenPackage;
    private ArrayList<String> apptype;
    ...
    public ArrayList<String> getHiddenPackage() {
        return hiddenPackage;
    }

    public void setHiddenPackage(ArrayList<String> hiddenPackage) {
    ...
    public void setApptype(ArrayList<String> apptype) {
    ...
    public String get_gg() {
        return _gg;
    }

    public void set_gg(String _gg) {
        this._gg = _gg;
    }
    ...
    public void setForbidForFreeApp(boolean forbidForFreeApp) {
        isForbidForFreeApp = forbidForFreeApp;
    }
